...
// {/* <div className=" min-h-74vh 2xl:min-h-screen flex justify-center items-center text-white  gap-5 md:gap-10  flex-wrap pt-4 sm:w-full">
//               <div
//                 className="w-11/12 max-w-sm 2xl:max-w-lg container rounded-xl shadow-lg transform hover:scale-105 hover:shadow-2xl dark:bg-main  transition-all duration-300 max-h-548px 2xl:max-h-max 2xl:min-h-38 rem  h-auto"
//                 key={data.id}
//                 onClick={() => handleDetails(data)}
//               >
//                 <div className="flex justify-between items-center my-3 px-4 ">
